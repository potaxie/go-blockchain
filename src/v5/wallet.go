...
import (
	...
	"crypto/sha256"
	"log"
	base582 "online-v5/lib/base58"
	//ripemd1602 "online-v5/lib/ripemd160"
...
func (w *Wallet) NewAddress() string {
	...
	address := base582.Encode(payload)
...
func IsValidAddress(address string) bool {
	//1. 解码
	addressByte := base582.Decode(address)
